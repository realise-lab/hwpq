...
file mkdir ./vivado_systolic_array_analysis_results_new
...
foreach queue_size $queue_sizes {
    ...
    set log_file "./vivado_systolic_array_analysis_results_new/vivado_analysis_on_queue_size_${queue_size}.txt"
