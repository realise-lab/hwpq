...
file mkdir ./SystolicArray/vivado_analysis_results_16bit 

# Loop through each QUEUE_SIZE
foreach queue_size $queue_sizes {

  # NOTE Change according to the module running analysis
  set file_id [open "./SystolicArray/rtl/SystolicArray.sv" r+]
  ...
  # NOTE - Change according to the module running analysis
  set log_file "./SystolicArray/vivado_analysis_results_16bit/vivado_analysis_on_queue_size_${queue_size}.txt"

  # Loop through each frequency
  for {set freq 100} {$freq <= 800} {incr freq 50} {
      
    # NOTE Change according to the module running analysis
    open_project ./SystolicArray/SystolicArray-vivado/SystolicArray-vivado.xpr
