...
file mkdir ./RegisterTree/vivado_analysis_results_16bit/enqueue_0/
file mkdir ./RegisterTree/vivado_analysis_results_16bit/enqueue_1/
...
foreach enq_flag $enq_flags {
  ...
  # Replace the parameter ENQUEUE value
  ...
  foreach queue_size $queue_sizes {
    ...
    # NOTE - Change according to the module running analysis
    set log_file "./RegisterTree/vivado_analysis_results_16bit/enqueue_${enq_flag}/vivado_analysis_on_queue_size_${queue_size}.txt"
