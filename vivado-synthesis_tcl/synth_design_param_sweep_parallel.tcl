...
set sv_file_path /home/qw2246/Workspace/hwpq_qw2246/register_tree/rtl/src/register_tree.sv
set base_log_path /home/qw2246/Workspace/hwpq_qw2246/register_tree/vivado_analysis_results_16bit_parallel_test
...
foreach clock_freq $clock_freq_values {
  ...
  synth_design -top register_tree -part $running_device -generic ENQ_ENA=$enq_ena -generic QUEUE_SIZE=$queue_size -flatten_hierarchy full
