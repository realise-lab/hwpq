...
file mkdir ./hybrid_tree/vivado_analysis_results_16bit 
...
foreach queue_size $queue_sizes {
    ...
    # NOTE - Change according to the module running analysis
    set file_id [open "./hybrid_tree/hybrid_tree.sv" r+] 
    ...
    # NOTE - Change according to the module running analysis
    set log_file "./hybrid_tree/vivado_analysis_results_16bit/vivado_analysis_on_queue_size_${queue_size}.txt"

    # Loop through each frequency
    for {set freq 100} {$freq <= 800} {incr freq 50} {
        
        #! Change according to the module running analysis
        open_project ./hybrid_tree/vivado_hybrid_tree/vivado_hybrid_tree.xpr
