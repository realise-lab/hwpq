...
file mkdir ./RegisterTree/vivado_analysis_results_16bit_cycled/enqueue_0/
file mkdir ./RegisterTree/vivado_analysis_results_16bit_cycled/enqueue_1/

foreach enq_flag $enq_flags {
  # NOTE Change according to the module running analysis
  set file_id [open "./RegisterTree/rtl/RegisterTree_Cycled.sv" r+]
  ...
  foreach queue_size $queue_sizes {
    ...
    # NOTE - Change according to the module running analysis
    set log_file "./RegisterTree/vivado_analysis_results_16bit_cycled/enqueue_${enq_flag}/vivado_analysis_on_queue_size_${queue_size}.txt"

    # Loop through each frequency
    for {set freq 100} {$freq <= 800} {incr freq 50} {

      # NOTE Change according to the module running analysis
      open_project ./RegisterTree/RegisterTree-vivado/RegisterTree-vivado.xpr
